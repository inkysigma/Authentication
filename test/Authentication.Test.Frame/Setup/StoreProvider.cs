...
namespace Authentication.Test.Frame.Setup
{
    public class StoreProvider
    {
        public static IUserPasswordStore<TestUser> CreateMockPasswordStore()
        {
            ...
            mock.SetupSequence(
                    moq => moq.SetPasswordAsync(It.IsAny<TestUser>(), It.IsAny<byte[]>(), It.IsAny<CancellationToken>()))
                .SetupExecution();

            mock.SetupSequence(
                    moq => moq.SetSaltAsync(It.IsAny<TestUser>(), It.IsAny<byte[]>(), It.IsAny<CancellationToken>()))
                .SetupExecution();
        ...
        public static IUserClaimStore<TestUser, TestClaim> CreateMockClaimStore()
        {
            ...
            mock.SetupSequence(
                    moq =>
                        moq.CreateClaimAsync(It.IsAny<TestUser>(), It.IsAny<TestClaim>(),
                            It.IsAny<CancellationToken>()))
                .SetupExecution();
        ...
        public static IUserLockoutStore<TestUser> CreateMockLockoutStore()
        {
            ...
            mock.SetupSequence(
                    moq => moq.LockoutAsync(It.IsAny<TestUser>(), It.IsAny<DateTime>(), It.IsAny<CancellationToken>()))
                .SetupExecution();
        ...
        public static IUserLoginStore<TestUser, TestLogin> CreateMockLoginStore()
        {
            ...
            mock.SetupSequence(
                    moq =>
                        moq.DeleteUserLoginAsync(It.IsAny<TestUser>(), It.IsAny<TestLogin>(),
                            It.IsAny<CancellationToken>()))
                .SetupExecution();
